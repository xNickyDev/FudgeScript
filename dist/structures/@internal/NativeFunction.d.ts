import { ApplicationEmoji, AttachmentBuilder, BaseChannel, Guild, GuildEmoji, GuildForumTag, GuildMember, Invite, Message, MessageReaction, PermissionsString, ReactionEmoji, Role, Sticker, TextBasedChannel, User, Webhook } from "discord.js";
