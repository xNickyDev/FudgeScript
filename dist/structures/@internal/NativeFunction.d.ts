import { ApplicationEmoji, AttachmentBuilder, AutoModerationRule, BaseChannel, Emoji, Entitlement, Guild, GuildEmoji, GuildForumTag, GuildMember, GuildScheduledEvent, GuildTemplate, Invite, Message, MessageReaction, PermissionsString, Role, Sticker, TextBasedChannel, User, Webhook } from "discord.js";
