import { ApplicationEmoji, AttachmentBuilder, AutoModerationRule, BaseChannel, Emoji, Entitlement, Guild, GuildEmoji, GuildForumTag, GuildMember, GuildScheduledEvent, GuildTemplate, Integration, Invite, Message, MessageReaction, PermissionsString, Role, SoundboardSound, StageInstance, Sticker, TextBasedChannel, User, Webhook } from "discord.js";
