...
class Arg {
    ...
    static restAutomodRule(name = "rule IDs", desc = "The guild automod rules to use", required = false) {
        return Arg.create({
            name,
            description: desc,
            rest: true,
    ...
    static restEntitlement(name = "entitlement IDs", desc = "The entitlements to use", required = false) {
        return Arg.create({
            name,
            description: desc,
            rest: true,
