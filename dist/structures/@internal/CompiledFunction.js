...
class CompiledFunction {
    ...
    hasDisabledConsoleErrors(fn) {
        return this.data.suppress || fn.data.suppress;
    }
    return(value) {
    ...
    success(value = null) {
        return new Return_1.Return(Return_1.ReturnType.Success, this.data.negated ? null : this.data.count !== null && typeof (value) === "string" ? (value === "" ? 0 : value.split(this.data.count).length) : value);
    }
}
