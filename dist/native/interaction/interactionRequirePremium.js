...
exports.default = new structures_1.NativeFunction({
    ...
    deprecated: true,
    async execute(ctx) {
        structures_1.Logger.deprecated("$interactionRequirePremium is deprecated and will be removed with discord.js v15.0.0, please use the new premium-style buttons, this is the new Discord behavior.");
