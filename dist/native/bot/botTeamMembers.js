...
exports.default = new structures_1.NativeFunction({
    ...
    async execute(ctx, [prop, sep]) {
        ...
        const members = owner instanceof discord_js_1.Team ? owner.members : null;
        if (members && !this.hasFields)
            return this.successJSON(members);
        return this.success(prop ? members?.map(x => teamMember_1.TeamMemberProperties[prop](x)).join(sep ?? ", ") : null);
    },
});
