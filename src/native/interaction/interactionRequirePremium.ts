...
export default new NativeFunction({
    ...
    async execute(ctx) {
        Logger.deprecated(
            "$interactionRequirePremium is deprecated and will be removed with discord.js v15.0.0, please use the new premium-style buttons, this is the new Discord behavior."
        )
